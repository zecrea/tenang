      ...
      <q-card flat bordered class="card">
        <q-card-section horizontal>
          <q-img 
            height="360px" 
            width="30%"
            src="~assets/img/headline-left.jpg"
          >
            <div class="overlay-grad-2 absolute-full text-subtitle2 column justify-end items-center">
              <q-btn 
                class="btn-custom"
                color="white" 
                text-color="primary"
...
export default {
  ...
  data () {
    return {
      aboutContent: this.$loremGen.generateParagraphs(3),
      lorem: this.$loremGen.generateParagraphs(2),
      slidePage: 1
    }
  },
  computed: {
